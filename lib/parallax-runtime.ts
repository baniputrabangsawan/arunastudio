...
export function mountParallax(root: HTMLElement, { revealOnScroll = true } = {}) {
  ...
  media.add(
    ...
    (context) => {
      ...
      const revealGroups = revealOnScroll
        ? Array.from(root.querySelectorAll<HTMLElement>("main section .container"))

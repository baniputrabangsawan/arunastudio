...
export default async function ServiceDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main>
    ...
    <section className="section bg-[var(--paper)]"><div className="container grid gap-12 lg:grid-cols-[.7fr_1.3fr]"><div><p className="eyebrow">FAQ layanan</p><h2 className="heading !text-5xl">Sebelum memilih.</h2></div><FaqAccordion faqs={service.faqs}/></div></section>

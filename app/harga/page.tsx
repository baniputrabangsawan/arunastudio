...
export const metadata:Metadata={title:"Harga Jasa Website",description:"Paket transparan ARUNA: landing page Rp400.000–Rp800.000, company profile Rp900.000–Rp1.400.000, dan custom website mulai Rp2.000.000.",alternates:{canonical:"/harga"}};
